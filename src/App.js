    ...
    <>
      ...
      <div class="container">
        <div id="about">
          ...
          <div class="content">
            <p class="aboutTitle"> Award winning real estate company in Dubai </p>
            <p class="aboutComment"> Semper arcu mauris aliquam lacus. Massa erat vitae ultrices pharetra scelerisque.
              Ipsum, turpis facilisis tempor pulvinar in lobortis ornare magna. </p>
        ...
        <div class="ongingProject">
          <div class="ongingProject-container">
            <div>
              ...
              <p class="subTitle ">Turpis facilisis tempor pulvinar in lobortis ornare magna..</p>
            </div>
        ...
        <div id="testimonials">
          ...
          <p class="subTitle text-center">Turpis facilisis tempor pulvinar in lobortis ornare magna.</p>
          <div class="grid">
            <div class="image">
              <img src={rectangle} />
            </div>
            <div class="ig">
              ...
              <p class="comment"> Semper arcu mauris aliquam lacus. Massa erat vitae ultrices pharetra scelerisque.
                Ipsum, turpis facilisis tempor pulvinar. </p>
        ...
        <div id="contactForm">
          ...
          <div class="half">
            ...
            <form>
              ...
              <textarea class="textarea" name="description" rows="4" cols="50" placeholder="Description"></textarea><br/>
          ...
          <div class="footer-menu">
            ...
            <div class="info">
              <div class="icon-container">
                ...
                <p>2118 Thornridge Cir. Dubai,<br/> UAE 35624</p>
              </div>
              <div class="icon-container">
